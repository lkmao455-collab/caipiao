...
def build_features(
    ...
    """构建 QLC 训练特征与标签."""
    return _build_features(records, profile=QLC, lookback=lookback)
...
def build_prediction_features(
    ...
    """为最新一期构建 QLC 预测特征."""
    return _build_prediction_features(records, profile=QLC, lookback=lookback)
