...
class SSQLightGBMModel(LotteryGenericModel):
    """SSQ 专用的 LightGBM 顺序生成模型.
    ...
    def __init__(self, lookback: int = 50, temp_dir: str | None = None) -> None:
        super().__init__(profile=SSQ, lookback=lookback, backend="lightgbm", temp_dir=temp_dir)
