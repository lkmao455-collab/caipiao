...
def build_features(
    ...
    """构建 DLT 训练特征与标签."""
    return _build_features(records, profile=DLT, lookback=lookback)
...
def build_prediction_features(
    ...
    """为最新一期构建 DLT 预测特征."""
    return _build_prediction_features(records, profile=DLT, lookback=lookback)
