...
def build_features(
    ...
    """构建 PL5 训练特征与标签."""
    return _build_features(records, profile=PL5, lookback=lookback)
...
def build_prediction_features(
    ...
    """为最新一期构建 PL5 预测特征."""
    return _build_prediction_features(records, profile=PL5, lookback=lookback)
