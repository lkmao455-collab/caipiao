...
class LotteryLightGBMModel:
    ...
    def __init__(self, lookback: int = 50, temp_dir: Optional[str] = None) -> None:
        ...
        self.red_sequence_model: Optional[lgb.LGBMClassifier] = None
    ...
    def fit(
        ...
        logger.debug("红球顺序生成 LightGBM 训练完成")
    ...
    def save(self, path: Path | str) -> None:
        ...
        logger.info("LightGBM 模型已保存到 %s", path)
    ...
    def load(self, path: Path | str) -> None:
        ...
        logger.info("LightGBM 模型已从 %s 加载", path)
